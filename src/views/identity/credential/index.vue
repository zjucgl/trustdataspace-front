      ...
      <div style="height: calc(100vh - 260px)">
        ...
        >
          <el-table-column
            ...
            align="center"
          />
          <el-table-column prop="id" label="凭证ID" align="center" />
          <el-table-column prop="holderId" label="持有者" align="center" />
          <el-table-column label="持有凭证类型" align="center">
            <template #default="scope">
              <el-tag
                v-for="(item, index) in scope.row.verifiableCredential
                  .credential.type"
                :key="index"
                class="mr-2"
              >
          ...
          <el-table-column
            prop="verifiableCredential.rawVc"
            label="vc凭证"
            align="center"
